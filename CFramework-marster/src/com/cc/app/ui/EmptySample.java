...
import com.cc.app.R;
import com.cc.app.ui.widget.EmptyLayout;

public class EmptySample extends ListActivity {
	...
	private View.OnClickListener mErrorClickListener = new OnClickListener() {			
		...
		public void onClick(View v) {
			Toast.makeText(EmptySample.this, "Try again button clicked", Toast.LENGTH_LONG).show();			
		}
	};
